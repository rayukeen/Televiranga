...
import com.televiranga.spagreen.adapters.LiveTvAdapter2;
import com.televiranga.spagreen.adapters.SearchAdapter;
import com.televiranga.spagreen.network.RetrofitClient;
import com.televiranga.spagreen.network.apis.SearchApi;
import com.televiranga.spagreen.network.model.CommonModel;
import com.televiranga.spagreen.network.model.SearchModel;
import com.televiranga.spagreen.network.model.TvModel;
...
public class SearchActivity extends AppCompatActivity implements SearchAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Resultado de búsqueda");
        ...
        searchQueryTv.setText("Mostrando resultado para : "+query );
        ...
        call.enqueue(new Callback<SearchModel>() {
            ...
            public void onResponse(Call<SearchModel> call, retrofit2.Response<SearchModel> response) {
                ...
                if (response.code() == 200) {
                    ...
                    new ToastMsg(SearchActivity.this).toastIconSuccess("Algo salió mal.");
                    coordinatorLayout.setVisibility(View.VISIBLE);
                }
